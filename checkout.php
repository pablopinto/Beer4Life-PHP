    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="mobile-nav">
            ...
            <div class="amado-navbar-brand">
                <a href="main.html"><img src="img/core-img/logo.png" alt=""></a>
            </div>
            <!-- Navbar Toggler -->
        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li class="active"><a href="checkout.html">Mis Productos</a></li>
                </ul>
            </nav>
            <!-- Button Group -->
                            ...
                            <form action="#" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="company" placeholder="Compañia" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control mb-3" id="street_address" placeholder="Direccion" value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <input type="text" class="form-control" id="city" placeholder="Ciudad" value="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="text" class="form-control" id="zipCode" placeholder="Codigo Postal" value="">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="number" class="form-control" id="phone_number" min="0" placeholder="Numero Tel." value="">
                                    </div>
                                    <div class="col-12 mb-3">
                                        <textarea name="comment" class="form-control w-100" id="comment" cols="30" rows="10" placeholder="Deja un comentario sobre tu pedido"></textarea>
                                    </div>

                                    <div class="col-12">
                                        <div class="custom-control custom-checkbox d-block mb-2">
                                            <input type="checkbox" class="custom-control-input" id="customCheck2">
                                            <label class="custom-control-label" for="customCheck2">Create una cuenta</label>
                                        </div>
                                        <div class="custom-control custom-checkbox d-block">
                                            <input type="checkbox" class="custom-control-input" id="customCheck3">
                                            <label class="custom-control-label" for="customCheck3">Mandar a otra direccion</label>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="cart-summary">
                            ...
                            <div class="payment-method">
                                ...
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    ...
                                    <label class="custom-control-label" for="cod">A contra-reembolso</label>
                                </div>
                                <!-- Paypal -->
                                <div class="custom-control custom-checkbox mr-sm-2">
                                ...
                                <div class="custom-control custom-checkbox mr-sm-2">
                                        <input type="checkbox" class="custom-control-input" id="paypal">
                                        <label class="custom-control-label" for="paypal">Tarjeta Credito <img class="ml-15" src="img/core-img/paypal.png" alt=""></label>
                                    </div>
                            </div>
                                ...
                                <nav class="navbar navbar-expand-lg justify-content-end">
                                    ...
                                    <div class="collapse navbar-collapse" id="footerNavContent">
                                        <ul class="navbar-nav ml-auto">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="checkout.html">Mis Compras</a>
                                            </li>
                                        </ul>
                                    </div>
                                </nav>
