                ...
                <div class="col-12">
                    <div class="search-content">
                        <form action="#" method="get">
                            <input type="stearch" name="search" id="search" placeholder="Type your keyword...">
       ...
       <header class="header-area clearfix">
        ...
        <nav class="amado-nav">
            <ul>
                ...
                <li class="active"><a href="product-details.php">Productos</a></li>
                    ...
                    <div class="col-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mt-50">
                                ...
                                <li class="breadcrumb-item"><a href="#">Tipo1</a></li>
                                <li class="breadcrumb-item"><a href="#">Alhambra</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Alhambra 1925 </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="short_overview my-5">
                                <p>Cerveza wena sabrosa y de colorines para todos , biba la sevesa</p>
                            </div>
                            ...
                            <form class="cart clearfix" method="post">
                                ...
                                <button type="submit" name="addtocart" value="5" class="btn amado-btn">Añadir al carrito</button>
                            </form>
